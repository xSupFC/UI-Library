--// Sentinel Library Fixed! \\--
--Fixed by xSupFC#0945
---------------------------------

pcall(function()
    game:GetService('CoreGui'):FindFirstChild('local.gui.name/math.random.string.value'):Destroy() 
end) 
...
function Library.AddWindow(s) 
    ...
    ui.Name = "local.gui.name/math.random.string.value"
