...
function lib:Window(text, text2, closebind)
    CloseBind = closebind or Enum.KeyCode.RightControl
    PresetColor = Color3.fromRGB(0, 255, 225)
    fs = false
    ...
    DropdownHolderUICorner.CornerRadius = UDim.new(0, 8)
    DropdownHolderUICorner.Name = "DropdownHolderUICorner"
    DropdownHolderUICorner.Parent = Main
    ...
    Title.Position = UDim2.new(0.0339285731, 0, 0.0164263314, 0)
    ...
    Title2.Position = UDim2.new(0.0339285731, 0, 0.0564263314, 0)
    Title2.Size = UDim2.new(0, 200, 0, 23)
    Title2.Font = Enum.Font.GothamSemibold
    Title2.Text = text2
    Title2.TextColor3 = PresetColor
    ...
    Title1.Position = UDim2.new(0.9339285731, 0, 0.0364263314, 0)
    Title1.Size = UDim2.new(0, 20, 0, 23)
    Title1.Font = Enum.Font.GothamSemibold
    Title1.Text = "X"
    Title1.TextColor3 = PresetColor
    Title1.TextSize = 16.000
    Title1.TextXAlignment = Enum.TextXAlignment.Right
    Title1.MouseButton1Click:Connect(function()
    ...
    DragFrame.Size = UDim2.new(0, 560, 0, 41)
                ...
                DropdownHolderUIStroke.Parent = Main
                DropdownHolderUIStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
                DropdownHolderUIStroke.Color = PresetColor
...
Barload.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
...
LoadTitle.Position = UDim2.new(0.3432743616, 0, 0.1125011, 0)
LoadTitle.Size = UDim2.new(0, 200, 0, 23)
LoadTitle.Font = Enum.Font.GothamSemibold
LoadTitle.Text = "ZEXO-WARE | ZW"
...
LoadFrame2.Visible = false
    ...
    function lib:Notification(textdesc)
        ...
        local D1ropdownHolderUIStroke = Instance.new("UIStroke")
        local DropdownHolderUICorner1 = Instance.new("UICorner")
        ...
        NotificationFrame.Position = UDim2.new(0.5, 0, 0.498432577, 0)
                ...
                DropdownHolderUICorner1.CornerRadius = UDim.new(0, 8)
                DropdownHolderUICorner1.Name = "DropdownHolderUICorner"
                DropdownHolderUICorner1.Parent = NotificationFrame
                
                D1ropdownHolderUIStroke.Name = "DropdownHolderUIStroke"
                D1ropdownHolderUIStroke.Parent = NotificationFrame
                D1ropdownHolderUIStroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
                D1ropdownHolderUIStroke.Color = PresetColor 
                D1ropdownHolderUIStroke.LineJoinMode = Enum.LineJoinMode.Round
                D1ropdownHolderUIStroke.Thickness = 3
                D1ropdownHolderUIStroke.Transparency = 0
                D1ropdownHolderUIStroke.Enabled = true
                D1ropdownHolderUIStroke.Archivable = true
        ...
        OkayBtnTitle.Position = UDim2.new(0.3670731738, 0, 0, 0)
        ...
        NotificationTitle.Position = UDim2.new(0.1970731738, 0, 0.0829015523, 0)
        ...
        NotificationDesc.TextColor3 = PresetColor
    ...
    function tabhold:Tab(text)
        ...
        function tabcontent:Button(text, callback)
            ...
            ButtonTitle.TextColor3 = PresetColor
        ...
        function tabcontent:Toggle(text,default, callback)
            ...
            FrameToggle2.BackgroundColor3 = Color3.fromRGB(14, 14, 14)
        ...
        function tabcontent:Colorpicker(text, preset, callback)
            ...
            RainbowToggle.BackgroundColor3 = Color3.fromRGB(14, 14, 14)
        ...
        function tabcontent:Textbox(text, disapper, callback)
            ...
            TextboxFrame.BackgroundColor3 = PresetColor
        ...
        function tabcontent:Bind(text, keypreset, callback)
            ...
            Bind.Name = "Bind"
            Bind.Parent = Tab
            Bind.BackgroundColor3 = Color3.fromRGB(14, 14, 14)
            ...
            BindTitle.Text = text
            BindTitle.TextColor3 = PresetColor
