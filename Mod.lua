...
_G.ColorXD = Color3.fromRGB(0,255,0)
local Dino = {}

local TweenService = game:GetService("TweenService")
local UserInputService = game:GetService("UserInputService") 

function Dino:TitleHack(te)
    ...
    Window.Position = UDim2.new(0, 100, 0, 130)
    Window.Size = UDim2.new(0, 200, 0, 240)
    
    DinoHubText1.Name = "DinoHubText1"
    DinoHubText1.Parent = Window
    DinoHubText1.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
    DinoHubText1.BackgroundTransparency = 1.000
    DinoHubText1.BorderSizePixel = 0
    DinoHubText1.Position = UDim2.new(0, 12, 0, 0)
    DinoHubText1.Size = UDim2.new(0, 170, 0, 20)
    DinoHubText1.Font = Enum.Font.GothamSemibold
    DinoHubText1.Text = te
    DinoHubText1.TextColor3 = _G.ColorXD
    ...
    DinoHubText2.Text = ""
    DinoHubText2.TextColor3 = _G.ColorXD
    ...
    WindowText.Size = UDim2.new(0, 200, 0, 20)
    ...
    TabWindow.Position = UDim2.new(0, 0, 0, 20)
    TabWindow.Size = UDim2.new(0, 200, 0, 20)
    ...
    ContainerHolder.Size = UDim2.new(0, 200, 0, 250)

    Togglee.Name = "Togglee"
    Togglee.Parent = DinoUI
    ...
    function DinoWindow:Discord(name, num)
        ...
        Container.Size = UDim2.new(0, 190, 0, 240)
        ...
        function DinoPage:NewSection(sectiontitle)
            ...
            function DinoElement:Button(buttontitle, buttoncallback)
                ...
                ButtonHolder.Size = UDim2.new(0, 350, 0, 40)
                ButtonHolder.AutoButtonColor = true
                ...
                ButtonHolderUIStroke.Color = _G.ColorXD
                ...
                ButtonHolder.MouseLeave:Connect(function()
                    ...
                    TweenService:Create(ButtonHolder, TweenInfo.new(0.12, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {Size = UDim2.new(0, 350, 0, 40)}):Play()
                end)
                ButtonHolder.MouseButton1Down:Connect(function()
                    TweenService:Create(ButtonHolder, TweenInfo.new(0.12, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {Size = UDim2.new(0, 345, 0, 40)}):Play()
                end)
            ...
            function DinoElement:Toggle(toggletitle, togglecallback)
                ...
                ToggleHolder.Size = UDim2.new(0, 350, 0, 40)
                ...
                ToggleTitle.Position = UDim2.new(0, 86, 0, 5)
                ...
                ToggleOut.Position = UDim2.new(0, 235, 0, 10)
                ...
                ToggleIn.BackgroundColor3 = _G.ColorXD
                ...
                ToggleHolderUIStroke.Color = _G.ColorXD
                ...
                ToggleHolderButton.MouseLeave:Connect(function()
                    ...
                    TweenService:Create(ToggleHolder, TweenInfo.new(0.12, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {Size = UDim2.new(0, 350, 0, 40)}):Play()
                end)
            ...
            function DinoElement:Textbox(textboxtitle, textboxplaceholdertitle,textboxcallback)
                ...
                TextBoxToggle.Size = UDim2.new(0, 350, 0, 40)
                ...
                TextBoxTitle.Position = UDim2.new(0, 86, 0, 5)
                TextBoxTitle.Size = UDim2.new(0, 250, 0, 25)
                ...
                TextBox.Position = UDim2.new(0, 237, 0, 10)
                TextBox.Size = UDim2.new(0, 30, 0, 18)
                TextBox.Font = Enum.Font.GothamSemibold
                TextBox.PlaceholderText = textboxplaceholdertitle or "Enter Text"
                TextBox.Text = ""
                TextBox.TextColor3 = _G.ColorXD
                ...
                TextBoxHolderUIStroke.Color = _G.ColorXD
            ...
            function DinoElement:Dropdown(dropdowntitle, list, dropdowncallback)
                list = list or {}
                ...
                DropdownHolderTitle.Position = UDim2.new(0, 86, 0, 0)
                DropdownHolderTitle.Size = UDim2.new(0, 250, 0, 25)
                ...
                DropdownSelectedTitle.BackgroundColor3 = _G.ColorXD
                DropdownSelectedTitle.BorderSizePixel = 0
                DropdownSelectedTitle.Position = UDim2.new(0, 266, 0, 2)
                DropdownSelectedTitle.Size = UDim2.new(0, -50, 0, 20)
                DropdownSelectedTitle.Font = Enum.Font.Code
                ...
                DropdownHolderUIStroke.Color = _G.ColorXD
            ...
            function DinoElement:CreateLabel(labeltitle)
                ...
                DropdownHolderTitle.TextColor3 = Color3.fromRGB(0, 255, 255)
                DropdownHolderTitle.TextSize = 13.000
                DropdownHolderTitle.TextXAlignment = Enum.TextXAlignment.Left

                local DinoLabel = {}

                function DinoLabel:UpdateLabel(newlabeltitle)
