...
local Library = {
    Theme = {
        MainColor = Color3.fromRGB(80, 80, 80),
...
function Library:AddIntro(text2)
	...
	wait(2)
        ...
        wait(1)
        setSize(80)
        Message.Text = "Waiting for Library"
        wait(.9)
        setSize(100)
...
local Title12 = Instance.new("TextButton")
local Title122 = Instance.new("TextButton")
...
Main.SliceCenter = Rect.new(60, 60, 60, 60)
Main.SliceScale = 0.010
...
TextBox.Size = UDim2.new(0, 449, 0, -50)
...
Title1.Name = "Title"
Title1.Parent = TextBox
Title1.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Title1.BackgroundTransparency = 1.000
Title1.Size = UDim2.new(0, 80, 0, 20)
Title1.Position = UDim2.new(0, 10, 0, 17)
Title1.ZIndex = 2
Title1.Font = Enum.Font.Code
Title1.Text =  "Zexo Software | v0.2.0"
Title1.TextColor3 = Color3.fromRGB(255, 255, 255)
Title1.TextSize = 20
Title1.TextXAlignment = Enum.TextXAlignment.Left

Title12.Name = "Title"
Title12.Parent = TextBox
Title12.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Title12.BackgroundTransparency = 1.000
Title12.Size = UDim2.new(0, 20, 0, 20)
Title12.Position = UDim2.new(0, 415, 0, 17)
Title12.ZIndex = 2
Title12.Font = Enum.Font.Code
Title12.Text =  "x"
Title12.TextColor3 = Color3.fromRGB(255, 255, 255)
Title12.TextSize = 20
Title12.TextXAlignment = Enum.TextXAlignment.Right
Title12.MouseButton1Click:Connect(function()
TweenService:Create(Main, TweenInfo.new(0.8, Library.Theme.EasingStyle, Enum.EasingDirection.Out), {Size = UDim2.new(0, 0, 0, 0)}):Play()
TweenService:Create(TextBox, TweenInfo.new(0.8, Library.Theme.EasingStyle, Enum.EasingDirection.Out), {Size = UDim2.new(0, 0, 0, 0)}):Play()
Main.ClipsDescendants = true  
wait(.8)
UILibrary:Destroy()
end)

Open.Parent = UILibrary
...
Title122.Name = "Title"
Title122.Parent = TextBox
Title122.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Title122.BackgroundTransparency = 1.000
Title122.Size = UDim2.new(0, 20, 0, 20)
Title122.Position = UDim2.new(0, 391, 0, 18)
Title122.ZIndex = 2
Title122.Font = Enum.Font.Code
Title122.Text =  "-"
Title122.TextColor3 = Color3.fromRGB(255, 255, 255)
Title122.TextSize = 20
Title122.TextXAlignment = Enum.TextXAlignment.Right
Title122.MouseButton1Click:Connect(function()
    Open.Visible = true
    Main.Visible = false
end)
...
function Library:CreateTab(name)
    ...
    function TabElements:CreateSection(name)
        ...
        function SectionElements:Label(name, text)
        ...
        function SectionElements:Button(name, callback)
        ...
        function SectionElements:Toggle(name, callback)
        ...
        function SectionElements:Slider(name, minimumvalue, maximumvalue, presetvalue, precisevalue, callback)
        ...
        function SectionElements:ColorPicker(name, presetcolor, callback)
        ...
        function SectionElements:Dropdown(name, options, presetoption, callback)
            ...
            for i, v in pairs(options) do
                ...
                NameButton.MouseButton1Down:Connect(function()
                    ...
                    TitleToggle.Text = (name .. " - " .. SelectedOption)
                    TweenService:Create(NameButton, TweenInfo.new(0.35, Library.Theme.EasingStyle, Enum.EasingDirection.Out), {TextColor3 = Color3.new(255,255,255)}):Play()
        ...
        function SectionElements:Keybind(name, presetbind, keyboardonly, holdmode, callback)
